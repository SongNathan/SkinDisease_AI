    ...
    with app.app_context():
        ...
        descriptions = [
            ...
            "disease_name" : "여드름(Acne)",
             "description": "Acne(여드름)은 피지와 죽은 피부 세포로 모공이 막혀 염증을 유발하면서 발생합니다.\n"
            "스트레스를 풀고 충분한 수면 등을 통해 신체 휴식을 적절히 취해주는 것이 좋습니다. "
            "수면 부족은 정상적인 성장 호르몬에 의한 피부 재생 기능을 제대로 이루어지지 못하게 하여 "
            "각질을 방치하고, 피부에 영양공급이 부실하게 되어 염증이 잘 생기게 합니다.\n"
            "추천 음식 : 당근, 시금치, 통곡물"},
            {"class_name": "Atopic",
            "disease_name" : "아토피(Atopic dermatitis)", 
